...
typedef struct {
	element queue[MAX_QUEUE_SIZE]; //element를 queue[MAX_QUEUE_SIZE]로 선언 
	int front, rear; 
}QueueType; //구조체를 호출용 이름
